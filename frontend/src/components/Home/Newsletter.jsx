  ...
  return (
    <div className='p-10 sm:p-20 flex flex-col items-center gap-5 '>
      <div className='flex flex-col items-center '>
        <h3 className='text-3xl sm:text-4xl'>Never miss an update!</h3>
        <p className='text-zinc-500 text-sm sm:text-xl text-center '>Subcribe to get the latest news, new features, and exclusive updates.</p>
    </div> 
    <div>
        <div className="p-0 border border-zinc-300 rounded  ">
